...
export function repositoryFindings(index) {
  ...
  return [
    finding({
      id: 'repository.readme', category: 'Repository', status: readme ? 'pass' : 'fail', title: 'README',
    ...
    finding({
      id: 'repository.license', category: 'Repository', status: license ? 'pass' : 'warn', title: 'License',
    ...
    finding({
      id: 'repository.gitignore', category: 'Repository', status: gitignore ? 'pass' : 'warn', title: '.gitignore',
    ...
    finding({
      id: 'repository.ci', category: 'Repository', status: ci ? 'pass' : 'warn', title: 'Continuous integration',
    ...
    finding({
      id: 'repository.tests', category: 'Repository', status: tests ? 'pass' : 'warn', title: 'Automated tests',
