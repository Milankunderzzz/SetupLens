...
- 75 automated tests, executed in CI on Windows, Linux, and macOS with Node.js 18 and 22;
...
jobs:
  setuplens:
    ...
    steps:
      ...
      - uses: Milankunderzzz/SetupLens@v0.2.0-alpha.2
        with:
          path: .
          threshold: 75
```
